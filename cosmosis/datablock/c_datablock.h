...
extern "C" {
  ...
  */
  ...
  /*
    ...
    section, DBS_USED_DEFAULT if the named section exists but carries
    no parameter of the given name, and an error status otherwise.

    If the return status is neither DBS_SUCCESS not DBS_USED_DEFAULT,
    the value written into 'val' is not defined.
  */
