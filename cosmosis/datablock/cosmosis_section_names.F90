...
module cosmosis_section_names
    ...
    character(*), parameter :: dark_matter_power_lin_section = "dark_matter_power_lin"
    character(*), parameter :: dark_matter_power_nl_section = "dark_matter_power_nl"
    character(*), parameter :: baryon_power_lin_section = "baryon_power_lin"
    character(*), parameter :: baryon_power_nl_section = "baryon_power_nl"
    character(*), parameter :: photon_power_lin_section = "photon_power_lin"
    character(*), parameter :: photon_power_nl_section = "photon_power_nl"
    character(*), parameter :: massless_neutrino_power_lin_section = "massless_neutrino_power_lin"
    character(*), parameter :: massless_neutrino_power_nl_section = "massless_neutrino_power_nl"
    character(*), parameter :: massive_neutrino_power_lin_section = "massive_neutrino_power_lin"
    character(*), parameter :: massive_neutrino_power_nl_section = "massive_neutrino_power_nl"
    character(*), parameter :: cdm_baryon_power_lin_section = "cdm_baryon_power_lin"
    character(*), parameter :: cdm_baryon_power_nl_section = "cdm_baryon_power_nl"
    character(*), parameter :: matter_de_power_lin_section = "matter_de_power_lin"
    character(*), parameter :: matter_de_power_nl_section = "matter_de_power_nl"
    character(*), parameter :: weyl_curvature_power_lin_section = "weyl_curvature_power_lin"
    character(*), parameter :: weyl_curvature_power_nl_section = "weyl_curvature_power_nl"
    character(*), parameter :: cdm_velocity_power_lin_section = "cdm_velocity_power_lin"
    character(*), parameter :: cdm_velocity_power_nl_section = "cdm_velocity_power_nl"
    character(*), parameter :: baryon_velocity_power_lin_section = "baryon_velocity_power_lin"
    character(*), parameter :: baryon_velocity_power_nl_section = "baryon_velocity_power_nl"
    character(*), parameter :: baryon_cdm_relative_velocity_power_lin_section = "baryon_cdm_relative_velocity_power_lin"
    character(*), parameter :: baryon_cdm_relative_velocity_power_nl_section = "baryon_cdm_relative_velocity_power_nl"
