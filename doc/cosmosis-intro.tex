...
\newcommand{\authors}{
  Scott Dodelson, Jim Kowalkowski, and Marc Paterno (\textit{FNAL}) \\%
  Sarah Bridle and Joe Zuntz (\textit{University of Manchester}) \\%
  Douglas Rudd (\textit{RCC, University of Chicago})
}
