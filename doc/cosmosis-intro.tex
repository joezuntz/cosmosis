...
\item[Scientist user]: \emph{Scientist users} (henceforth just
  ...
  Users need the set of code contained in the {Installed products repository} (see Fig.\ref{fig:roles}); it will
  be installed in the {runtime environment}, which could be a laptop, a small cluster, or a national facility such as NERSC.
